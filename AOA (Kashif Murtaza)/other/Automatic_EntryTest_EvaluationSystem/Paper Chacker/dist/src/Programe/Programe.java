...
import ExamSheet.DataCollector;
import automaticpapercheker.PaperChaker;
 ...
 * @author Basham
 */
public class Programe extends javax.swing.JFrame {

    /**
     * Creates new form Programe
     */
    public Programe() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        PaperChaker pc=new PaperChaker();
        pc.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Programe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
